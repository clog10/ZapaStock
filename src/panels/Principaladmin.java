...
public class Principaladmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbUsuarioR = new javax.swing.JButton();
        ...
        jbUsuarioR.setBackground(new java.awt.Color(224, 224, 224));
        jbUsuarioR.setText("Producto");
        jbUsuarioR.setBorder(null);
        jbUsuarioR.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jbUsuarioRMouseClicked(evt);
            }
        });
        jbUsuarioR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbUsuarioRActionPerformed(evt);
            }
        });
        jPanel3.add(jbUsuarioR, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, -20, 100, 20));
        ...
        panelGradient1.add(jbProductosR, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 100, 30));
    ...
    private void jbRegistrosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbRegistrosMouseClicked
        ...
        AnimationClass regi = new AnimationClass();
        regi.jButtonYDown(-20, 40, 10, 5, jbUsuarioR);
        AnimationClass regii = new AnimationClass();
        regii.jButtonYUp(40, -20, 10, 5, jbUsuarioR);
    ...
    private void jbUsuarioRMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbUsuarioRMouseClicked
       if (panelLogo.isVisible() || panelApartado.isVisible() || panelregpro.isVisible() || panelVenta.isVisible() || panelCatalogo.isVisible()){
            panelLogo.setVisible(false);
            panelApartado.setVisible(false);
            panelregpro.setVisible(false);
            panelVenta.setVisible(false);
    ...
    }//GEN-LAST:event_jbUsuarioRMouseClicked

    private void jbUsuarioRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbUsuarioRActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jbUsuarioRActionPerformed
    ...
    private javax.swing.JButton jbUsuarioR;
